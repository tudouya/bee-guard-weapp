...
function S(t, e, i) {
    var n = P(t, e, i), a = i.yAxisWidth, r = n.map(function(t) {
        return t = O.toFixed(t, 2), t = e.yAxis.format ? e.yAxis.format(Number(t)) : t, 
...
function M(t, e, i, n, r, s) {
    ...
    t.forEach(function(t, l) {
        ...
        O.approximatelyEqual(h.x, 0) ? f -= o(n.categories[l] || "") / 2 : h.x < 0 && (f -= o(n.categories[l] || "")), 
...
function _(t, e, i, n, r, s) {
    ...
    t.map(function(t) {
        return {
            ...
            text: t.format ? t.format(+t._proportion_.toFixed(2)) : O.toFixed(100 * t._proportion_) + "%",
            color: t.color
        };
    }).forEach(function(t) {
        ...
        c && O.isSameXCoordinateArea(c.start, {
            x: f
        }) && (u = f > 0 ? Math.min(d, c.start.y) : e < 0 || d > 0 ? Math.max(d, c.start.y) : Math.min(d, c.start.y)), 
        f < 0 && (f -= x);
        var g = {
            lineStart: {
                x: a,
        ...
        c = function(t, e) {
            if (e) for (;O.isCollision(t, e); ) t.start.x > 0 ? t.start.y-- : t.start.x < 0 || t.start.y > 0 ? t.start.y++ : t.start.y--;
            return t;
        }(g, c), h.push(c);
...
function w(t, e, i, n) {
    var a = v(t, e, i), r = a.xAxisPoints, s = (a.startX, a.endX, a.eachSpacing), l = e.height - i.padding - i.xAxisHeight - i.legendHeight, h = l + i.xAxisLineHeight;
...
function k(t, e, i, n) {
    if (!0 !== e.yAxis.disabled) {
        var a = S(t, e, i).rangesFormat, r = i.yAxisWidth + i.yAxisTitleWidth, s = e.height - 2 * i.padding - i.xAxisHeight - i.legendHeight, l = Math.floor(s / i.yAxisSplit), h = i.padding + r, c = e.width - i.padding, f = e.height - i.padding - i.xAxisHeight - i.legendHeight;
...
function C(t, e, i, n) {
    e.legend && u(t, e, i).legendList.forEach(function(t, a) {
        var r = 0;
        t.forEach(function(t) {
...
function I(t) {
    ...
    var e = "undefined" != typeof requestAnimationFrame ? requestAnimationFrame : "undefined" != typeof setTimeout ? function(t, e) {
        ...
        if (null === i && (i = a), a - i < t.duration) {
            ...
            o = (0, X[t.timing])(o), t.onProcess && t.onProcess(o), e(n, 17);
...
function z(t, e, i, r) {
    var s = this, c = e.series, f = e.categories, d = u(c = function(t, e) {
        var i = 0;
        return t.map(function(t) {
            return t.color || (t.color = e.colors[i], i = (i + 1) % e.colors.length), t;
        });
    }(c, i), e, i).legendHeight;
    i.legendHeight = d;
    var P = S(c, e, i).yAxisWidth;
    if (i.yAxisWidth = P, f && f.length) {
        var z = function(t, e, i) {
            var n = {
                angle: 0,
                xAxisHeight: i.xAxisHeight
            }, a = v(t, e, i).eachSpacing, r = t.map(function(t) {
                return o(t);
            ...
            n;
        }(f, e, i), D = z.xAxisHeight, W = z.angle;
        i.xAxisHeight = D, i._xAxisTextAngle_ = W;
    }
    "pie" !== t && "ring" !== t || (i._pieTextMaxLength_ = !1 === e.dataLabel ? 0 : function(t) {
        t = p(t);
        var e = 0;
        return t.forEach(function(t) {
            var i = t.format ? t.format(+t._proportion_.toFixed(2)) : O.toFixed(100 * t._proportion_) + "%";
            e = Math.max(e, o(i));
        }), e;
    }(c));
    ...
    switch (this.animationInstance && this.animationInstance.stop(), t) {
      case "line":
        this.animationInstance = new I({
            timing: "easeIn",
            duration: X,
            onProcess: function(t) {
                L(e, i, r);
                var a = function(t, e, i, a) {
                    var o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1, r = S(t, e, i), s = r.ranges, l = v(e.categories, e, i), h = l.xAxisPoints, c = l.eachSpacing, f = s.pop(), d = s.shift(), u = [];
                    return a.save(), e._scrollDistance_ && 0 !== e._scrollDistance_ && !0 === e.enableScroll && a.translate(e._scrollDistance_, 0), 
                    e.tooltip && e.tooltip.textList && e.tooltip.textList.length && 1 === o && E(e.tooltip.offset.x, e, i, a), 
                    t.forEach(function(t, r) {
                        var s = m(t.data, f, d, h, c, e, i, o);
                        if (u.push(s), x(s).forEach(function(i, o) {
                            ...
                            var l = i.dataPointShape[r % i.dataPointShape.length];
                            T(s, t.color, l, a);
                        }
                    }), !1 !== e.dataLabel && 1 === o && t.forEach(function(t, n) {
                        b(m(t.data, f, d, h, c, e, i, o), t, i, a);
                    }), a.restore(), {
                        xAxisPoints: h,
                        calPoints: u,
                        eachSpacing: c
                    };
                }(c, e, i, r, t), o = a.xAxisPoints, l = a.calPoints, h = a.eachSpacing;
                s.chartData.xAxisPoints = o, s.chartData.calPoints = l, s.chartData.eachSpacing = h, 
                w(f, e, i, r), C(e.series, e, i, r), k(c, e, i, r), F(e, i, r, t), H(0, r);
            },
            onAnimationFinish: function() {
                s.event.trigger("renderComplete");
            }
        });
        break;
        ...
        this.animationInstance = new I({
            ...
            onProcess: function(t) {
                ...
                var n = function(t, e, i, n) {
                    var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1, o = S(t, e, i), r = o.ranges, s = v(e.categories, e, i), l = s.xAxisPoints, h = s.eachSpacing, c = r.pop(), f = r.shift();
                    ...
                    t.forEach(function(o, r) {
                        var s = m(o.data, c, f, l, h, e, i, a);
                        s = y(s, h, t.length, r, i, e), n.beginPath(), n.setFillStyle(o.color), s.forEach(function(t, a) {
                            if (null !== t) {
                        ...
                        var s = m(o.data, c, f, l, h, e, i, a);
                        s = y(s, h, t.length, r, i, e), !1 !== e.dataLabel && 1 === a && b(s, o, i, n);
                    }), n.restore(), {
                        xAxisPoints: l,
                        eachSpacing: h
                    };
                }(c, e, i, r, t), a = n.xAxisPoints, o = n.eachSpacing;
                s.chartData.xAxisPoints = a, s.chartData.eachSpacing = o, w(f, e, i, r), C(e.series, e, i, r), 
                k(c, e, i, r), H(0, r);
            },
            onAnimationFinish: function() {
                s.event.trigger("renderComplete");
      ...
      case "area":
        this.animationInstance = new I({
            ...
            onProcess: function(t) {
                L(e, i, r);
                var a = function(t, e, i, a) {
                    var o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1, r = S(t, e, i), s = r.ranges, l = v(e.categories, e, i), h = l.xAxisPoints, c = l.eachSpacing, f = s.pop(), d = s.shift(), u = e.height - i.padding - i.xAxisHeight - i.legendHeight, g = [];
                    return a.save(), e._scrollDistance_ && 0 !== e._scrollDistance_ && !0 === e.enableScroll && a.translate(e._scrollDistance_, 0), 
                    e.tooltip && e.tooltip.textList && e.tooltip.textList.length && 1 === o && E(e.tooltip.offset.x, e, i, a), 
                    t.forEach(function(t, r) {
                        var s = m(t.data, f, d, h, c, e, i, o);
                        if (g.push(s), x(s).forEach(function(i) {
                            ...
                            a.setLineWidth(2), i.length > 1) {
                                ...
                                a.moveTo(o.x, o.y), "curve" === e.extra.lineStyle ? i.forEach(function(t, e) {
                                    ...
                                    e > 0 && a.lineTo(t.x, t.y);
                                }), a.lineTo(r.x, u), a.lineTo(o.x, u), a.lineTo(o.x, o.y);
                            } else {
                                var s = i[0];
                                a.moveTo(s.x - c / 2, s.y), a.lineTo(s.x + c / 2, s.y), a.lineTo(s.x + c / 2, u), 
                                a.lineTo(s.x - c / 2, u), a.moveTo(s.x - c / 2, s.y);
                            }
      ...
      case "pie":
        this.animationInstance = new I({
            ...
            duration: X,
            onProcess: function(t) {
                s.chartData.pieData = function(t, e, i, n) {
                    ...
                    return 1 === a && "ring" === e.type && A(e, i, n), {
                        center: r,
                        radius: s,
                        series: t
                    };
                }(c, e, i, r, t), C(e.series, e, i, r), H(0, r);
            },
            onAnimationFinish: function() {
                s.event.trigger("renderComplete");
            }
      ...
      case "radar":
        this.animationInstance = new I({
            ...
            duration: X,
            onProcess: function(t) {
                s.chartData.radarData = function(t, e, i, n) {
                    var o = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 1, r = e.extra.radar || {}, s = h(e.categories.length), c = {
                        x: e.width / 2,
                        y: (e.height - i.legendHeight) / 2
                    ...
                    for (var d = 1; d <= i.radarGridCount; d++) !function(t) {
                        var e = {};
                        n.beginPath(), n.setLineWidth(1), n.setStrokeStyle(r.gridColor || "#cccccc"), s.forEach(function(o, r) {
                    ...
                    return g(s, c, f, t, e, o).forEach(function(t, a) {
...
I.prototype.stop = function() {
    this.isStop = !0;
}, D.prototype.addEventListener = function(t, e) {
...
var G = function(e) {
    ...
    this.chartData = {}, this.event = new D(), this.scrollOption = {
        currentOffset: 0,
        startTouchX: 0,
        distance: 0
    }, z.call(this, e.type, e, i, this.context);
};

G.prototype.updateData = function() {
    ...
    z.call(this, this.opts.type, this.opts, this.config, this.context);
}, G.prototype.stopAnimation = function() {
    this.animationInstance && this.animationInstance.stop();
}, G.prototype.addEventListener = function(t, e) {
    this.event.addEventListener(t, e);
}, G.prototype.getCurrentDataIndex = function(t) {
    ...
    if (e && e.length) {
        ...
        return "pie" === this.opts.type || "ring" === this.opts.type ? function(t, e) {
            ...
            return f(t, i, n) && e.forEach(function(e, i) {
                t.x + a > e && (o = i);
            }), o;
        }({
            x: a,
    ...
    return -1;
}, G.prototype.showToolTip = function(e) {
    ...
    if ("line" === this.opts.type || "area" === this.opts.type) {
        ...
        if (n > -1) {
            var r = s(this.opts.series, n);
            if (0 !== r.length) {
                var l = c(r, this.chartData.calPoints, n, this.opts.categories, i), h = l.textList, f = l.offset;
                o.tooltip = {
                    textList: h,
                    offset: f,
                    option: i
        ...
        z.call(this, o.type, o, this.config, this.context);
    }
}, G.prototype.scrollStart = function(t) {
    t.touches[0] && !0 === this.opts.enableScroll && (this.scrollOption.startTouchX = t.touches[0].x);
}, G.prototype.scroll = function(e) {
...
}, G.prototype.scrollEnd = function(t) {
